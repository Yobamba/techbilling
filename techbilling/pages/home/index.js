    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="font-playfair font-bold text-4xl text-foreground mb-4">Welcome to TechBilling</h1>
          ...
          <Card className="bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20">
            <CardHeader>
              <CardTitle className="font-playfair text-2xl">Quick Overview</CardTitle>
